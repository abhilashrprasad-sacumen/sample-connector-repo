class AWSConnector:
    ...
    def __repr__(self):
        return f"AWSConnector(name={self.name}, connector_id={self.connector_id}, description={self.description}, provider={self.provider}, status={self.status}, total_assets={self.total_assets}, last_synced_on={self.last_synced_on}, is_gov_cloud={self.is_gov_cloud}, is_china_region={self.is_china_region}, aws_account_id={self.aws_account_id}, is_disabled={self.is_disabled}, polling_frequency={self.polling_frequency}, error={self.error}, base_account_id={self.base_account_id}, external_id={self.external_id}, arn={self.arn}, nextSyncedOn={self.nextSyncedOn}, remediationEnabled={self.remediationEnabled}, qualysTags={self.qualysTags}, portalConnectorUuid={self.portalConnectorUuid}, isPortalConnector={self.isPortalConnector})"
